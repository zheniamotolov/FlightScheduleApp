...
package com.demo.schedularapp.api;
 ...
 */
public interface LifeStatsService {
    @GET("/airports/rest/v1/json/{airportsState}")
    LiveData<ApiResponse<AirportListItemEntity>> getUser(
            @Path("airportsState") String airportsState,
